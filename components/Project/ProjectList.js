...
const ProjectList = ({ projects }) => {
  ...
  const classes = [
    "md:mt-[2vw] md:rotate-[10deg] md:col-start-1 md:top-[-20px]",
    "md:mt-[6vw] md:rotate-[-8deg] md:col-start-3",
    "md:mt-[0vw] md:rotate-[9deg] md:col-start-5 ",

    "md:mt-[-5vw] md:rotate-[3deg] md:col-start-2 md:-ml-[13rem] md:top-[-50px]",
    "md:mt-[-3vw] md:rotate-[-4deg] md:col-start-4 md:-mr-[10rem] md:top-[-120px]",
  ...
  const sizes = [28, 27, 27, 30, 30, 24, 27, 25, 25, 26, 24, 25, 24, 30];
